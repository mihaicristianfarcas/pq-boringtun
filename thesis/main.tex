...
\romaniantitle{Schimb hibrid de chei post-cuantic pentru WireGuard: integrarea ML-KEM într-o implementare de producție în spațiul utilizator, scrisă în Rust}

\maketitle

% Romanian-language title page (UBB Ghid requirement)
\maketitleromanian
...
\input{chapters/chapter4_problem}
\input{chapters/chapter5_design}
\input{chapters/chapter6_implementation}
\input{chapters/chapter7_security}
\input{chapters/chapter8_evaluation}
\input{chapters/chapter9_discussion}
